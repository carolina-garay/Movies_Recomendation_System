...
-  :one: Google Drive: se utilizó la cuenta de quien les escribe para almacenar el conjunto de datos de los datasets, ambos conjuntos se descargaron en el notebook ETL_Garay.ipynb

- :two: Visual Studio Code: se utilizó este editor de código para crear un directorio con el nombre del proyecto y se implementó un entorno virtual de forma local. En este entorno se procedió a crear la API junto a los end point ‘/’.
- :three: Google Colaboratory: Se utilizó esta plataforma para el desarrollo de los procesos ETL, EDA y Modelo de Machine Learning. 
...
- Render: se utilizó este sitio para desplegar el proyecto. Primeramente se creó una cuenta en el sitio
